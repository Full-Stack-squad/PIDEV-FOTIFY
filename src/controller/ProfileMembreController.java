...
public class ProfileMembreController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btn_addFeedback.setOnMouseClicked((MouseEvent e) -> {
            try {
                if (btn_addFeedback.getText().equals("Modifier Commentaire")) {
                    ...
                    ModifierFeedbackController ModifyFeedbackController = l.getController();
        ...
        System.out.println("yup : " + UserDao.connectedUser);
        Node no;
        try {
        ...
        PhotoServiceDao ps1 = null;
        ps1 = new PhotoServiceDao();
        InputStream stream;
