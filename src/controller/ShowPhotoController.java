...
public class ShowPhotoController implements Initializable {
    ...
    public int setIdd(int id) {
        ...
        savebtn.setOnAction(e->{saveToFile(immg); JOptionPane.showMessageDialog(null, "Photo téléchargée");});//jdiiiid7
        g = id;
        ...
        btncomm.setOnAction(e -> {
            ...
            else{JOptionPane.showMessageDialog(null, "veuillez saisir un commentaire");}
