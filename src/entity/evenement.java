...
public class evenement {
    ...
    public evenement(int id, String titre, String contenu, String image, Date dateajout, Date datemodif, ImageView photo) {
        this.id = id;
        this.titre = titre;
        this.contenu = contenu;
        this.image = image;
    ...
    public evenement(String titre, String contenu, String image, Date dateajout, Date datemodif, ImageView photo) {
        this.titre = titre;
        this.contenu = contenu;
        this.image = image;
        this.dateajout = dateajout;
